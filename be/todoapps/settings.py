"""
Django settings for todoapps project.
...
SECRET_KEY = 'django-insecure-)9zz1ij1(lgkswij@eeb5%-iiefc_coks%ou3$&0r@f0g=bz9o'
...
MIDDLEWARE = [
    ...
    'api.middleware.TodoappsMiddleware',
